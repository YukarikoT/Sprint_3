...
class TestLocators:
    ...
    NAME_INPUT_REG = By.XPATH, ".//fieldset[1]//input"
    EMAIL_INPUT_REG = By.XPATH, ".//fieldset[2]//input"
    PASSWORD_INPUT_REG = By.NAME, "Пароль"
    REGISTRATION_BUTTON = By.TAG_NAME, "button"
    PASSWORD_INPUT_ERROR_REG = By.XPATH, ".//p[text()='Некорректный пароль']"
